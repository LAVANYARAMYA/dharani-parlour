    	...
    	<div class="container">
          ...
          <div class="col-md-6 text-center heading-section ftco-animate">
    		...
    		<div class="row no-gutters">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				<img src="images/pic2.jpg" class="img-fluid" alt="Colorlib Template">
	    				<div class="text">
	    					<span>Beauty</span>
	    					<h3>Makeup</h3>
	    				</div>
	    				<a href="images/pic2.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="icon-expand"></span>
	    				</a>
    				</div>
    			</div>
