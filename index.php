	      ...
	      <div class="slider-item js-fullheight">
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
	          	<img class="one-third align-self-end order-md-last img-fluid" src="images/pic8.jpeg" alt="">
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
		          		<span class="subheading">Beauty Parlour</span>
			            <h1 class="mb-4">YOUR DREAM DAY IN STYLE</h1>
			            <p class="mb-4">Come see our bride's corner and take the opportunity to schedule your date by seeing our bride's corner.</p>
	      ...
	      <div class="slider-item js-fullheight">
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
	          	<img class="one-third align-self-end order-md-last img-fluid" src="images/pic2.jpg" alt="">
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
		          		<span class="subheading">OUR STORY</span>
			            <h1 class="mb-4">Beauty Salon</h1>
			            <p class="mb-4">"DHARANI BEAUTY PARLOUR"is a family-possessed business committed to giving perfection to our administration!

Our committed group of beauticians, nails, and skin specialists accompany innumerable long periods of involvement in the magnificence business.</p>
